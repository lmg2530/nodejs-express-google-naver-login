...
{alert("id 媛� naver_id_login �� div tag 媛� 議댁옱�댁빞 �⑸땲��.");return false;}
...
{alert("state 媛믪씠 留욎씠 �딆뒿�덈떎.");this.callback_status="warning";this.callback_message="state miss match";}}}}
else
